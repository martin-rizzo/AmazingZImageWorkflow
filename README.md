...
1. simple-zimage-SAFETENSORS.json: Suitable for 8GB+ VRAM
2. simple-zimage-GGUF.json: Recommended for 4-12GB VRAM 
3. simple-zimage-GGUFSMALL.json: For systems with less than 8GB VRAM
...
### simple-zimage-SAFETENSORS.json
